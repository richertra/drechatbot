...
embeddings_file_path = "embeddings4.npy"

# Lire le fichier Excel
file_path = #ADAPTER EN FONCTION 
df = pd.read_excel(file_path)

# Extraire les termes et les catégories associées
terms = df['Question'].dropna().tolist()
...
# Vérification de la cohérence entre le nombre de termes, catégories et embeddings
...
# Annoter les points avec les catégories associées
for i, category in enumerate(categories):
    plt.annotate(category, (tsne_results[i, 0], tsne_results[i, 1]), fontsize=8, color='black', alpha=0.7,
